...
!define PRODUCT_VERSION "${SLACKIE_VERSION}" 
!define APP_NAME "Slackie"


Name "${APP_NAME}"
Caption "${APP_NAME} ${SLACKIE_VERSION}"
BrandingText "${APP_NAME} ${SLACKIE_VERSION}"
VIAddVersionKey "ProductName" "${APP_NAME}"
VIAddVersionKey "ProductVersion" "${SLACKIE_VERSION}"
VIAddVersionKey "FileDescription" "${APP_NAME} ${SLACKIE_VERSION} Installer"
VIAddVersionKey "FileVersion" "${SLACKIE_VERSION}"
...
!define MUI_FINISHPAGE_RUN "$INSTDIR\Slackie.exe"
...
Section
    ...
    CreateShortCut "$SMPROGRAMS\${APP_NAME}\${APP_NAME}.lnk" "$INSTDIR\Slackie.exe" "" "$INSTDIR\resources\app\images\SLACKIE_icon.ico" "" "" "" "${APP_NAME} ${SLACKIE_VERSION}"
    CreateShortCut "$SMPROGRAMS\${APP_NAME}\Uninstall ${APP_NAME}.lnk" "$INSTDIR\Uninstall.exe" "" "$INSTDIR\resources\app\images\SLACKIE_icon.ico" "" "" "" "Uninstall ${APP_NAME}"
    ...
    WriteRegStr HKCU "${UNINSTALL_KEY}" "DisplayVersion" "${SLACKIE_VERSION}"
    WriteRegStr HKCU "${UNINSTALL_KEY}" "DisplayIcon" "$INSTDIR\resources\app\images\SLACKIE_icon.ico"
...
Function finishpageaction
    CreateShortCut "$DESKTOP\${APP_NAME}.lnk" "$INSTDIR\Slackie.exe" "" "$INSTDIR\resources\app\images\SLACKIE_icon.ico" "" "" "" "${APP_NAME} ${SLACKIE_VERSION}"
FunctionEnd
